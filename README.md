<p align="center">
  <img src="assets/icon.png" width="128" height="128" alt="Claude Terminal Title icon" />
</p>
...
<p align="center">
  <img src="assets/before-after.png" width="640" alt="Before: tabs say 'node' / 'zsh'. After: tabs say 'Auth Refactor', 'review · PR #42', etc." />
</p>
...
- **Open source, MIT.** The whole thing is ~300 lines of JS — read it: [`extension/src/`](extension/src/).

Found something I missed? [Open an issue.](https://github.com/ranmedina/claude-terminal-title/issues)
